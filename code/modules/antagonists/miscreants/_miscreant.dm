...
/datum/antagonist/miscreant/proc/specialize()
	...
	addtimer(CALLBACK(owner.mind, .proc/add_antag_datum, pickweight(elligible_miscreants)), 0)

	owner.mind.remove_antag_datum(type)
